...
2. Use symbol/reference-aware navigation where available (for example Serena), especially before touching large AHK entry points.
3. Verify Discord/network/library APIs against current official documentation before changing integration code. Context7 may assist, but official docs remain authoritative.
